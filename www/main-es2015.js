...
const routes = [
    ...
    {
        path: 'alert',
        loadChildren: () => Promise.all(/*! import() | pages-irlestr-s-alert-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-irlestr-s-alert-module")]).then(__webpack_require__.bind(null, /*! ./pages/irlestrés/alert.module */ "./src/app/pages/irlestrés/alert.module.ts")).then(m => m.AlertPageModule)
    },
    {
        path: 'action-sheet',
        loadChildren: () => Promise.all(/*! import() | pages-irl-action-sheet-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-irl-action-sheet-module")]).then(__webpack_require__.bind(null, /*! ./pages/irl/action-sheet.module */ "./src/app/pages/irl/action-sheet.module.ts")).then(m => m.ActionSheetPageModule)
    },
    {
        path: 'activosliquidos',
        loadChildren: () => Promise.all(/*! import() | pages-activosliquidos-activosliquidos-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-activosliquidos-activosliquidos-module")]).then(__webpack_require__.bind(null, /*! ./pages/activosliquidos/activosliquidos.module */ "./src/app/pages/activosliquidos/activosliquidos.module.ts")).then(m => m.ActivosliquidosPageModule)
    },
    {
        path: 'indicepromdemorosidad',
        loadChildren: () => Promise.all(/*! import() | pages-indicepromdemorosidad-indicepromdemorosidad-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-indicepromdemorosidad-indicepromdemorosidad-module")]).then(__webpack_require__.bind(null, /*! ./pages/indicepromdemorosidad/indicepromdemorosidad.module */ "./src/app/pages/indicepromdemorosidad/indicepromdemorosidad.module.ts")).then(m => m.IndicepromdemorosidadPageModule)
    },
];
...
module.exports = __webpack_require__(/*! C:\Users\javie\OneDrive\Documentos\udem jsom\metodología\front-del-p-a-metodologia-master\src\main.ts */"./src/main.ts");
