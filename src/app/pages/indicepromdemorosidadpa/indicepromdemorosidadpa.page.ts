...
@Component({
  selector: 'app-indicepromdemorosidadpa',
  templateUrl: './indicepromdemorosidadpa.page.html',
  styleUrls: ['./indicepromdemorosidadpa.page.scss'],
})
export class IndicepromdemorosidadpaPage implements OnInit {
  operandoA1: number;
  operandoA2: number;
  operandoA3: number;
  operandoA4: number;
